                ...
                <div class="info-input-outline">
                    <div class="signin-common-margin">
                        <div class="input-box">
                            ...
                            <input type="text" placeholder="휴대폰 번호(숫자만 허용)" autocomplete="username" value="">
                            <button id="verify" type="button">인증번호 요청</button>
                        </div>
                    </div>
                    <div class="signin-common-margin">
                        <div class="input-box">
                        ...
                        <div class="signin-select">
                            ...
                            <div class ="select-for-recommend">
                                <div class="gender-check">
                                    ...
                                    <label for="남성">
                                        <input id="남성" type="radio" value="0">남성</label>
                                    <label for="여성"></label>
                                        <input id="여성" type="radio" value="0">여성</label>
                                </div>
                                <div class="birth-year">
                                    <form>
                                        <label class ="select-space">태어난 해 :</label>
                                        <select name="select-year">
                                            <option value="" selected="selected" >선택</option>
                                            <option value="1991">1991</option>
                                            <option value="1992">1992</option>
                                        </select>
                                        <label class ="select-space">거래지역 :</label>
