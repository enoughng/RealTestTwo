...
<div class="sidebanner-layout">
            <div class="sb-size">
                ...
                <div class="rec-prd">
                    ...
                    <div class="rec-prd-img-group"> <!-- 이미지 그룹 -->
                        <a class="rec-prd-img" href="/products/128356672?content_position=3&amp;content_owner=3059906">
                            ...
                            <div class="prd_info">
                                ...
                                <div class="rec_prd_title">상품이름</div>
                                <div class="rec_prd_price">1000원</div>
                            </div> -->

                        </a>
                    </div>
                    <div class="rec-prd-paging"> <!--페이징 처리-->
