...
<!-- 페이지 CSS  -->
<link rel="stylesheet" href="<c:url value="/resources/css/user/products/products_new.css"/>">
                            ...
                            <div class="products-content--div">
                                ...
                                <div class="products-delivery-price--div">
                                    <div class="products-delivery-price--div2">
                                        <label for="freesShipping" class="products-delivery-price--label">
                                            <input id="freesShipping" type="checkbox">무료배송</label>
                                    </div>
                                    <div class="sc-bAtgIc jaIdBw">
                                        <label for="contactHope" class="products-delivery-price--label">
                                            <input id="contactHope" type="checkbox" name="">가격협의 가능</label>
                                    </div>
                                </div>
                            </div>
                        </li>
                                ...
                                <div class="products-tag--div">
                                    <div class="products-tag--div2">
                                        <div class="products-tag--div3">
                                            <input type="text" placeholder="연관태그를 입력해주세요. (최대 5개)" value=""></div>
                                    </div>
                                </div>
                            </div>
                        </li>
                ...
                <!-- 꼭 읽어주세요! 이용가이드 ... -->
                    <h3 class="products-footer--h3">
                        <span>
                            <!-- 이미지가 들어가야할 부분 --></span>
                        꼭 읽어주세요
                        <a href="#" target="_blank" rel="noopener noreferrer">이용 가이드</a>
                    </h3>
                    <p class="products-footer--p">
                        상품등록 시 <b>네모페이가 자동 적용</b>됩니다. 거래완료 후 등록된 계좌로 입금되며 <b>정산 확인은 ‘마이메뉴 < 구매/판매내역’</b>에서 가능합니다. </p>
                    </p>
