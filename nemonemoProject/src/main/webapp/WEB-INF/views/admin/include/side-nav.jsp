...
<link rel="stylesheet"
	href="<c:url value="/resources/vendor/plugins/morrisjs/morris.css"/>">

<!-- Custom Css -->
<!-- <link href="css/style.css" rel="stylesheet"> -->
<link rel="stylesheet"
	href="<c:url value="/resources/vendor/common/stylesheets/style.css"/>">
<!-- <link href="main.css" rel="stylesheet"> -->
<link rel="stylesheet"
	href="<c:url value="/resources/css/admin/main/ad_main.css"/>">
...
<body class="theme-red">
				...
				<div class="info-container">
					...
					<div class="btn-group user-helper-dropdown">
						...
						<ul class="dropdown-menu pull-right">
							...
							<li><a href="javascript:void(0);"><i
									class="material-icons">group</i>+Add</a></li>
							<li role="separator" class="divider"></li>
							<li><a href="javascript:void(0);"><i
			...
			<div class="menu">
				<ul class="list">
					...
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
							class="material-icons">widgets</i> <span>회원관리</span>
					</a>
						<ul class="ml-menu">
							<li><a href="members/member_CRUD.html">회원정보</a></li>
							<li><a href="members/member_care.html">1:1문의</a></li>
							<li><a href="members/member_coupon.html">회원쿠폰</a></li>
							<li><a href="members/member_report.html">신고관리</a></li>
						</ul></li>
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
							class="material-icons">assignment</i> <span>사이트 관리</span>
					</a>
						<ul class="ml-menu">
							<li><a href="#">카테고리 관리</a></li>
							<li><a href="#">배너(광고) 관리</a></li>
							<li><a href="#">공지사항 관리</a></li>
							<li><a href="#">이용약관 관리</a></li>
							<li><a href="#">프로모션 관리</a></li>
						</ul></li>
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
							class="material-icons">swap_calls</i> <span>상품 관리</span>
					</a>
						<ul class="ml-menu">
							<li><a href="#">상품관리</a></li>
						</ul></li>
					...
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							<li><a href="javascript:void(0);" class="menu-toggle"> <span>회원현황</span>
							</a>
								<ul class="ml-menu">
									<li><a href="#">총 회원 / 신규회원</a></li>
									<li><a href="#">성별 / 나이대</a></li>
									<li><a href="#">찜</a></li>

								</ul></li>
							<li><a href="javascript:void(0);" class="menu-toggle"> <span>판매현황</span>
							</a>
								<ul class="ml-menu">
									<li><a href="#">총 매출</a></li>
									<li><a href="#">카테고리별 매출</a></li>
									<li><a href="#">지역별 매출</a></li>
									<li><a href="#">가격대별</a></li>
								</ul></li>
						</ul></li>
					<li>
	...
	<script
		src="<c:url value="/resources/vendor/plugins/jquery/jquery.min.js"/>"></script>
	...
	<script
		src="<c:url value="/resources/vendor/plugins/chartjs/Chart.bundle.js"/>"></script>


	<!-- Flot Charts Plugin Js -->
	<!--         <script src="plugins/flot-charts/jquery.flot.js"></script> -->
	<script
		src="<c:url value="/resources/vendor/plugins/flot-charts/jquery.flot.js"/>"></script>

	<!--         <script src="plugins/flot-charts/jquery.flot.resize.js"></script> -->
	<script
		src="<c:url value="/resources/vendor/plugins/flot-charts/jquery.flot.resize.js"/>"></script>

	<!--  <script src="plugins/flot-charts/jquery.flot.pie.js"></script> -->
	<script
		src="<c:url value="/resources/vendor/plugins/flot-charts/jquery.flot.pie.js"/>"></script>

	<!--         <script src="plugins/flot-charts/jquery.flot.categories.js"></script> -->
	<script
		src="<c:url value="/resources/vendor/plugins/flot-charts/jquery.flot.categories.js"/>"></script>

	<!--    <script src="plugins/flot-charts/jquery.flot.time.js"></script> -->
	<script
		src="<c:url value="/resources/vendor/plugins/flot-charts/jquery.flot.time.js"/>"></script>
	...
	<script
		src="<c:url value="/resources/vendor/common/javascript/pages/index.js"/>"></script>
