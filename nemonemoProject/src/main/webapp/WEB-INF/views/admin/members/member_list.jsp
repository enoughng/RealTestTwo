...
<title>회원 목록</title>
<!-- 페이지 CSS -->
<link rel="stylesheet" href="<c:url value="/resources/css/admin/members/member_list.css"/>">

<!-- 페이지 JS -->
<script src="<c:url value="/resources/js/admin/members/member_list.js"/>"></script>
